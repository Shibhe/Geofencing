...
public class GeofenceSQLite extends SQLiteOpenHelper

    {
        ...
        // Login table name
        private static final String TABLE_USER = "geofence";
    ...
    public GeofenceSQLite(Context context) {
        ...
        String CREATE_GEOFENCE_TABLE = "CREATE TABLE " + TABLE_USER + "("
                + KEY_ID + " INTEGER PRIMARY KEY," + KEY_NAME + " TEXT,"
                + KEY_LATI + " TEXT UNIQUE,"
                + KEY_LONGI + " TEXT UNIQUE,";
         ...
         * */
    public void addUser(String name, Double latitude, Double longitude) {
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();
        values.put(KEY_NAME, name); // Name
        values.put(KEY_LATI, latitude.toString()); // Email
        values.put(KEY_LONGI, longitude.toString()); // Email
