...
--
-- Host: localhost
-- Generation Time: Oct 04, 2017 at 09:38 AM
...
INSERT INTO `tblLecturer` (`id`, `surname`, `initials`, `stuffNum`, `username`, `password`) VALUES
...
INSERT INTO `tblStudent` (`id`, `surname`, `initials`, `studNum`, `IDNo`, `gender`, `email`) VALUES
